...
const aiApps = [
  ...
  { name: "Sanitary Hardware POS", desc: "Full-featured Point of Sale system for a sanitaryware, tiles, and hardware retail store — built in Base44. Handles batch & lot tracking for colour/shade consistency across tile orders, flexible UoM conversion (sq. meter, sq. foot, box, length, bundle), kitting for multi-part sets with automatic component deduction, and a built-in area-to-box calculator with waste margin. Includes supplier ledgers, employee payroll & commission tracking, and real-time inventory control with low-stock alerts and multi-location warehouse support.", url: "sanitary-hardware-pos.base44.app", tag: "Base44 App" },
